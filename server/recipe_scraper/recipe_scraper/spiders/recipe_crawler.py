...
class RecipeCrawlerSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        if self.domain == 'food52.com':
            try:
                item['title'] = response.xpath("//meta[@name='sailthru.title']/@content")[0].extract().title()
                item['img_src'] = response.xpath("//meta[@property='og:image']/@content")[0].extract()
                item['author'] = response.xpath("//meta[@name='sailthru.author']/@content")[0].extract().title()
            ...
            try:
                ...
                item['img_src'] = response.xpath("//meta[@property='og:image']/@content")[0].extract()
                item['author'] = response.css("div.author-byline.brief > div > span > a::text").get().title()
                item['description'] = response.xpath("//meta[@name='description']/@content")[0].extract()
            ...
            try:
                item['title'] = response.xpath("//meta[@property='og:title']/@content")[0].extract().title()
                item['img_src'] = response.xpath("//meta[@property='og:image']/@content")[0].extract()
                item['author'] = response.xpath("//meta[@name='author']/@content")[0].extract().title()
                item['description'] = response.xpath("//meta[@name='description']/@content")[0].extract()
            ...
            try:
                item['title'] = response.xpath("//meta[@property='og:title']/@content")[0].extract().title()
                item['img_src'] = response.xpath("//meta[@property='og:image']/@content")[0].extract()
                item['author'] = response.css("div.nytc---recipebyline---bylinePart > a::text").get().title()
                item['description'] = response.xpath("//meta[@name='description']/@content")[0].extract()
            ...
            try:
                item['title'] = response.xpath("//meta[@property='og:title']/@content")[0].extract().title()
                item['img_src'] = response.xpath("//meta[@property='og:image']/@content")[0].extract()
                item['author'] = response.xpath("//meta[@property='article:author']/@content")[0].extract().title()
                item['description'] = response.xpath("//meta[@name='description']/@content")[0].extract()
            except:
                print('An error has occurred')
